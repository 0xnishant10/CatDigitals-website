...
export default function Footer() {
  return (
    <section className="body-font tails-selected-element bg-gray-900 text-gray-700">
        <div className="container mx-auto flex max-w-7xl flex-col items-center px-8 py-8 sm:flex-row">
          ...
          >
            CatDigitals<span className="text-indigo-600">.</span>
          </a>
          ...
          <span className="mt-4 inline-flex justify-center space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            <a href="https://www.facebook.com/profile.php?id=100093571020006" className="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://instagram.com/_catdigitals_?igshid=MzNlNGNkZWQ4Mg==" className="text-gray-400 hover:text-gray-500">
