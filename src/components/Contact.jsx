...
const Contact = () => {
  return (
    <>
      <section id='contact' class="flex items-center lg:h-screen font-poppins">
        <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-11 md:px-6">
          <div class="mb-10 text-left">
            <h2 class="pb-2 mb-2 text-xl font-bold text-black md:text-3xl">
              ...
              <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 sm:w-1/2">
                  <div class="max-w-xs mx-auto">
                    ...
                    <h2 class="mb-4 text-xl font-bold leading-9 md:text-2xl">
                      Email
                    </h2>
                    <a
                      href="#"
              ...
              <form action="https://getform.io/f/08a23ed7-c077-4cb1-a9fa-dbc484292abb" className="p-6" method="POST" encType="multipart/form-data">
                <div class="mb-6 ">
                  ...
                  <input
                    ...
                    required=""
                    class="block w-full px-4 py-3 mb-3 leading-tight  border border-gray-200 rounded  "
                  />
                </div>
                <div class="mb-6 ">
                  <label
                ...
                <div class="mb-6 ">
                  ...
                  <textarea
                    ...
                    required=""
                    class="block w-full px-4 leading-tight border border-gray-200 rounded  py-7 "
                  ></textarea>
                </div>
